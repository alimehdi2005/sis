...
if selected == "BOOK NOW":
    ...
    st.markdown("After filling out this form please check your email to confirm or reschedule your appointment")

    booking = """   
      <div class="container">
      <form target="_blank" action="https://formsubmit.co/gmcommercialcleaning05@gmail.com" method="POST">
        <div class="form-group">
          <div class="form-row">
            ...
            <div class="col">
              ...
              <div class="col">
              <input type="text" name="location" class="form-control" placeholder="Address / Location" required>
...
if selected == "CONTACT US":
  ...
  st.markdown("Please fill out this form to reach out to our support staff regarding any questions or concerns")
